...
// .proto file is parsed by protoc 3.21.8
// @generated
...
pub struct QuicJlsInboundSettings {
    // message fields
    // @@protoc_insertion_point(field:QuicJlsInboundSettings.certificate)
    pub certificate: ::std::string::String,
    // @@protoc_insertion_point(field:QuicJlsInboundSettings.certificate_key)
    pub certificate_key: ::std::string::String,
    // @@protoc_insertion_point(field:QuicJlsInboundSettings.pwd)
...
impl<'a> ::std::default::Default for &'a QuicJlsInboundSettings {
    fn default() -> &'a QuicJlsInboundSettings {
        <QuicJlsInboundSettings as ::protobuf::Message>::default_instance()
    }
}

impl QuicJlsInboundSettings {
    pub fn new() -> QuicJlsInboundSettings {
        ::std::default::Default::default()
    }
}

impl ::protobuf::Message for QuicJlsInboundSettings {
    const NAME: &'static str = "QuicJlsInboundSettings";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                58 => {
                    self.congestion_controller = is.read_string()?;
                },
                66 => {
                    self.alpn.push(is.read_string()?);
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.congestion_controller.is_empty() {
            my_size += ::protobuf::rt::string_size(7, &self.congestion_controller);
        }
        for value in &self.alpn {
            my_size += ::protobuf::rt::string_size(8, &value);
        };
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.congestion_controller.is_empty() {
            os.write_string(7, &self.congestion_controller)?;
        }
        for v in &self.alpn {
            os.write_string(8, &v)?;
        };
    ...
    fn new() -> QuicJlsInboundSettings {
        QuicJlsInboundSettings::new()
    }
    ...
    fn default_instance() -> &'static QuicJlsInboundSettings {
        static instance: QuicJlsInboundSettings = QuicJlsInboundSettings {
            certificate: ::std::string::String::new(),
            certificate_key: ::std::string::String::new(),
...
#[derive(PartialEq,Clone,Default,Debug)]
// @@protoc_insertion_point(message:QuicJlsOutboundSettings)
pub struct QuicJlsOutboundSettings {
    // message fields
    // @@protoc_insertion_point(field:QuicJlsOutboundSettings.address)
    pub address: ::std::string::String,
    // @@protoc_insertion_point(field:QuicJlsOutboundSettings.port)
    pub port: u32,
    // @@protoc_insertion_point(field:QuicJlsOutboundSettings.server_name)
    pub server_name: ::std::string::String,
    // @@protoc_insertion_point(field:QuicJlsOutboundSettings.pwd)
    pub pwd: ::std::string::String,
    // @@protoc_insertion_point(field:QuicJlsOutboundSettings.iv)
    pub iv: ::std::string::String,
    // @@protoc_insertion_point(field:QuicJlsOutboundSettings.zero_rtt)
    pub zero_rtt: bool,
    // @@protoc_insertion_point(field:QuicJlsOutboundSettings.congestion_controller)
    pub congestion_controller: ::std::string::String,
    // @@protoc_insertion_point(field:QuicJlsOutboundSettings.alpn)
    pub alpn: ::std::vec::Vec<::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:QuicJlsOutboundSettings.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a QuicJlsOutboundSettings {
    fn default() -> &'a QuicJlsOutboundSettings {
        <QuicJlsOutboundSettings as ::protobuf::Message>::default_instance()
    }
}

impl QuicJlsOutboundSettings {
    pub fn new() -> QuicJlsOutboundSettings {
        ::std::default::Default::default()
    }
}

impl ::protobuf::Message for QuicJlsOutboundSettings {
    const NAME: &'static str = "QuicJlsOutboundSettings";
    ...
    fn new() -> QuicJlsOutboundSettings {
        QuicJlsOutboundSettings::new()
    }
    ...
    fn default_instance() -> &'static QuicJlsOutboundSettings {
        static instance: QuicJlsOutboundSettings = QuicJlsOutboundSettings {
            address: ::std::string::String::new(),
            port: 0,
            server_name: ::std::string::String::new(),
            pwd: ::std::string::String::new(),
